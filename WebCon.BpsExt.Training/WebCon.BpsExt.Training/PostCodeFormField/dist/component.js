var component_bc19c114_ba5b_4fb1_a7cf_fe4f8709c052 = (function (react) {
	'use strict';
	...
	*/
	...
	var allowedWithoutShift = [8, // Backspace
	13, // Enter
	27, // Esc
	45, // Ins
	46 // Del
	];
	var allowedWithoutShiftChars = [109, // Numpad minus
	110, // Numpad dot
	173, // - (Firefox)
	188, // ,
	189, // -
	...
	var PostCodeFragment = /*#__PURE__*/function (_PureComponent) {
	  _inherits(PostCodeFragment, _PureComponent);

	  var _super = _createSuper(PostCodeFragment);

	  function PostCodeFragment() {
	    var _this;

	    _classCallCheck(this, PostCodeFragment);
	    ...
	    _defineProperty(_assertThisInitialized(_this), "handleChange", function (event) {
	      ...
	      var value = event.target.value;
	      var fixedValue = value.replace(/\D/g, '');
	      onChange(fixedValue);
	    });

	    _defineProperty(_assertThisInitialized(_this), "handlePaste", function (event) {
	      var pattern = new RegExp("^\\d{0,".concat(_this.props.maxLength, "}$"));
	    ...
	    _defineProperty(_assertThisInitialized(_this), "handleKeyDown", function (event) {
	      var functional = event.keyCode >= 112 && event.keyCode <= 123; // [F1] - [F12]

	      var hotkeys = !event.altKey && (contains(allowed, event.keyCode) || !event.shiftKey && contains(allowedWithoutShift, event.keyCode) || event.ctrlKey || event.metaKey);
	      var numerical;

	      if (event.key && event.key !== 'Unidentified') {
	        numerical = contains(allowedChars, event.key);
	      } else {
	        numerical = !event.shiftKey && contains(allowedWithoutShiftChars, event.keyCode) || !event.shiftKey && event.keyCode >= 48 && event.keyCode <= 57 || event.keyCode >= 96 && event.keyCode <= 105; // [0] - [9], [Num0] - [Num9]
	      }
	  ...
	  _createClass(PostCodeFragment, [{
	    ...
	    value: function render() {
	      ...
	      return webcon.createElement("input", {
	...
	_defineProperty(PostCodeFragment, "propTypes", {
	...
	var createState = function createState(data) {
	  var result = /^([0-9]{0,2})-{1}([0-9]{0,3})$/gi.exec(data);
	...
	var PostCode = /*#__PURE__*/function (_PureComponent) {
	  _inherits(PostCode, _PureComponent);
	  ...
	  function PostCode() {
	    ...
	    _defineProperty(_assertThisInitialized(_this), "handleBlur", function () {
	      ...
	      var _this$state = _this.state,
	          fragment1 = _this$state.fragment1,
	          fragment2 = _this$state.fragment2,
	          prevData = _this$state.prevData;
	      var data = fragment1 || fragment2 ? "".concat(fragment1, "-").concat(fragment2) : '';
	    ...
	    _defineProperty(_assertThisInitialized(_this), "handleChangeFragment1", function (value) {
	      _this.setState({
	        fragment1: value
	      });
	    });

	    _defineProperty(_assertThisInitialized(_this), "handleChangeFragment2", function (value) {
	      _this.setState({
	        fragment2: value
	      });
	    });
	    ...
	    _defineProperty(_assertThisInitialized(_this), "handleClick", function () {
	      ...
	      var _this$state2 = _this.state,
	          fragment1 = _this$state2.fragment1,
	          fragment2 = _this$state2.fragment2;
	  ...
	  _createClass(PostCode, [{
	    ...
	    value: function render() {
	      ...
	      return webcon.createElement("div", null, webcon.createElement(PostCodeFragment, {
	      ...
	      }), webcon.createElement("span", {
	        className: "post-code--separator"
	      }, "-"), webcon.createElement(PostCodeFragment, {
	        ...
	        isReadonly: isReadonly
	      }), !isReadonly && webcon.createElement("button", {
	        className: "post-code--clear-btn",
	        type: "button",
	        onClick: this.handleClick
	      }, webcon.createElement("img", {
	        className: "clear-btn--image",
	        src: "assets/clear"
	      })));
	    }
	  }], [{
	...
	_defineProperty(PostCode, "propTypes", {
	...
	var CustomControlComponent = function CustomControlComponent(_ref) {
	  ...
	  if (fieldConfiguration.editMode === 'ReadOnlyHtml' && !fieldConfiguration.isAdmin) {
	    ...
	    return webcon.createElement(PostCode, {
	      data: model,
	      onChange: onChange,
...
window.webcon.customControls.components['bc19c114-ba5b-4fb1-a7cf-fe4f8709c052'] = component_bc19c114_ba5b_4fb1_a7cf_fe4f8709c052;
